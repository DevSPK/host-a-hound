...
def user(id):
    """
    Query for a user by id and returns that user's info in a dictionary
    """
    user = User.query.get(id)
    return user.to_dict()


@user_routes.route("<int:current_id>/hosts")
@login_required
def get_hosts_by_user_id(current_id):
    """
    Query hosts by user id and returns all of the user's hosts in a list of host dictionaries
    """
